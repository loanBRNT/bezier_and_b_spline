...
tracerCourbeBspline(liste_test_5, 0.1, 5, type_vecteur="u")
plt.figure(3)
plt.title("BSPLINE ouvert uniforme")
tracerCourbeBspline(liste_test_5, 0.1, 5, type_vecteur="ou")



'''
plt.figure(1)
testFormeControle(liste_test_alpha)
plt.figure(4)
plt.title("Bezier")
tracerCourbesBezier(liste_test_alpha,0.1)
plt.figure(5)
plt.title("Bezier par morceaux (cubique)")
tracerCourbesBezier(liste_test_5,0.1,True)
plt.figure(6)
plt.title("Bezier par morceaux (cubique)")
tracerCourbesBezier(liste_test_alpha,0.1, True)
plt.figure(7)
plt.title("BSPLINE quelquonque")
tracerCourbeBspline(liste_test_alpha, 0.1, 2, type_vecteur="q")
'''